...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "mistral": HermesOverlay(extra_env_vars=("MISTRAL_API_KEY",),
                              base_url_override="https://api.mistral.ai/v1", base_url_env_var="MISTRAL_BASE_URL"),
    "scaleway": HermesOverlay(extra_env_vars=("SCALEWAY_API_KEY", "SCW_SECRET_KEY"),
                               base_url_override="https://api.scaleway.ai/v1", base_url_env_var="SCALEWAY_BASE_URL"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "nebius-token-factory": ("nebius", "nebius-tokenfactory", "nebius-tf", "token-factory", "tokenfactory", "nebius-ai", "nebius-studio"),
    "mistral": ("mistral-ai", "mistralai"), "scaleway": ("scw", "scaleway-ai"),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "mistral": "Mistral AI", "scaleway": "Scaleway Generative APIs",
